...
使用方式:
    from multi_language_corrector.utils import get_logger, TimingContext
...
# 定義專屬 logger 名稱
LOGGER_NAME = "multi_language_corrector"
...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    使用範例:
        ...
        logger = get_logger("engine")  # 取得 multi_language_corrector.engine
    """
    if name:
...
def enable_debug_logging() -> None:
    ...
    使用範例:
        from multi_language_corrector.utils import enable_debug_logging
