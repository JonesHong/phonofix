...
中文文本校正工具包 - 通用的中文詞彙替換引擎，支援 ASR 後處理、地域慣用詞轉換、縮寫擴展等多種應用場景
...
使用者需自行提供專有名詞字典，本工具會：
1. **自動生成模糊音變體**：將您提供的標準詞（如「台北車站」）自動產生所有可能的台式口音/模糊音變體（如「北車」、「臺北車站」等）
2. **智能文本校正**：當文本輸入時，自動將接近音的詞彙（如「北車」）轉換為您指定的正確專有名詞（如「台北車站」）

**適用場景**：
- ASR 語音識別後處理：修正語音識別錯誤
- 地域詞彙轉換：中國慣用詞 ↔ 台灣慣用詞
- 縮寫擴展：口語簡稱 → 正式全稱
- 錯別字修正：常見錯字 → 正確用字

**您的責任**：維護符合您業務領域的專有名詞字典
**本工具的責任**：提供強大的模糊音匹配與智能替換引擎
